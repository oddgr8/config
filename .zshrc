...
# Sometimes we get fzf not found during setup, this fixes that
...
plugins=(git zsh-autosuggestions fzf-tab fast-syntax-highlighting zsh-vi-mode) 
...
[ type python &> /dev/null ] || alias python=python3 && alias pip=pip3
